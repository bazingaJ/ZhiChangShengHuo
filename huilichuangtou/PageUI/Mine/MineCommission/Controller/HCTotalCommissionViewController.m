//
//  HCTotalCommissionViewController.m
//  huilichuangtou
//
...
#import "HCTotalCommissionCell.h"
#import "HCChargesModel.h"

@interface HCTotalCommissionViewController ()

@end

@implementation HCTotalCommissionViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIndentifier = @"HCTotalCommissionCell";
    HCTotalCommissionCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIndentifier];
    if (cell == nil) {
        cell = [[HCTotalCommissionCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier];
    }
...
- (void)getDataList:(BOOL)isMore {
    ...
    [param setValue:@"getChargesTotal" forKey:@"act"];

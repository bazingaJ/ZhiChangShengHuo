...
- (NSString *)touchBody {
    ...
    [body appendFormat:@"<div class=\"title\">%@</div>",self.activityModel.title];
    [body appendFormat:@"<div class=\"time\">活动时间：%@</div>",self.activityModel.date];
    if(!IsStringEmpty(self.activityModel.content)) {
        [body appendString:self.activityModel.content];
    }

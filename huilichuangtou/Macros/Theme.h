 ...
 *  默认白色
 */
#define WHITE_COLOR UIColorFromRGBWith16HEX(0Xffffff)
/**
 *  主题颜色
 */
#define MAIN_COLOR UIColorFromRGBWith16HEX(0xD2BA8D)
/**
 *  蓝色
 */
#define BLUE_COLOR UIColorFromRGBWith16HEX(0x4588EC)
/** 
 *  绿色
 */
#define GREEN_COLOR UIColorFromRGBWith16HEX(0x0AB194)
/**
 *  橙色
 */
#define ORANGE_COLOR UIColorFromRGBWith16HEX(0xD6BE7E)
/**
 *  红色
 */
